	...
	next: {
		...
		links: [
			...
			},
			{
				...
				note: "Pull, merge, derive, fan out to eleven sinks, and why a slow one never stops the loop",
			},
			{
	...
	next: {
		...
		links: [
			...
			},
			{
				...
				note: "Extraer, fusionar, derivar, repartir a once destinos, y por qué uno lento nunca para el bucle",
			},
			{
