...
una vez (como mucho 10 000 muestras, así que lo más corto entre `--buffer` y 10 000 / cadencia
segundos) e imprime cuántos segundos cubrió. Un `doctor` limpio dice que no hubo bucle, churn de
