...
2 en el <Measured id="squeeze.backgroundTwo" /> y 3 en el <Measured id="squeeze.atLeastThree" />, mientras que softnet no descartó nada
...
anillo, 60 s por defecto, y no escriben nada en ningún destino.
