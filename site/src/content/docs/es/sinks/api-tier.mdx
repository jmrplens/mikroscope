...
cadencia: <Measured id="api.conntrackMs" /> con <Measured id="conntrack.api" /> entradas en el RB5009 (hacia el 2026-09-11, un día antes de la lectura del slab; sin más precisión), una sola lectura sin dispersión. Está apagado por
...
API dijo <Measured id="conntrack.api" /> el día antes de que el slab dijera <Measured id="conntrack.slab" />.
