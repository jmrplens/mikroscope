...
description: Lo que el colector sigue preguntando a RouterOS por su API binaria, por qué casi todo es opcional, y las opciones y preajustes que deciden cuánto preguntar.
---
...
RouterOS envía al cerrar la sesión.
