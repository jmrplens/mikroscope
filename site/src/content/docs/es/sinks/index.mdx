...
| guardas datos a largo plazo en PostgreSQL o TimescaleDB       | `--sql`        | DDL e INSERTs para `psql`, sin driver               | no        |
...
| ya tienes Graphite, Elasticsearch o Telegraf                  | `--graphite`, `--elastic`, `--telegraf` | todas las medidas, con la forma de ese producto | no |
