...
escribe a once destinos —fichero, Prometheus e InfluxDB 3 entre ellos. Se publica como un archivo por
...
`ghcr.io/jmrplens/mikroscope` (linux/amd64, linux/arm64), y `deploy/` trae dos
