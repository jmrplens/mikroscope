...
`VERSION` es **1.0.10**, compilada en los dos binarios y lo que devuelve
`mikroscope version`; la última release publicada es la **v1.0.9**. Difieren porque
1.0.10 aún no está etiquetada, y 1.0.8 no lo estuvo nunca: la release salta de la
v1.0.7 a la v1.0.9, que lleva las dos. Una etiqueta `v*` lanza la
