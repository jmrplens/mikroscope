...
- `install --remote-image <referencia>` no sube nada: es el propio router quien descarga la imagen
  ...
  y en el camino del router hasta él, y mikroscope no verifica nada de lo que llega. El mismo ajuste
  guarda un único usuario y contraseña de registro para todo el equipo, que RouterOS presenta a
  cualquier registro del que descargue; [lo que el instalador rechaza](/mikroscope/es/security/installer/)
  explica qué supone y qué comprueba `doctor`.
