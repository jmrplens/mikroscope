...
- **The kernel is switching context four times as often as over its last day.** Algo empezó a
  ...
  un contenedor en un bucle cerrado. En el RB5009 de referencia fue una integración de Home
  Assistant que consultaba el router por la API (2026-09-23): las interrupciones del temporizador
  pasaron de unas 2 500 a unas 35 000 por segundo, en ráfagas de 20–90 s en un núcleo cada vez, y el
  perfil del propio RouterOS apenas lo mostraba. Al desactivar la integración la tasa volvió en
  30 s. Un cambio deliberado, como un contenedor nuevo o un conjunto de reglas más pesado, también
  la dispara.
