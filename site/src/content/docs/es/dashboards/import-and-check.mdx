...
Grafana → Dashboards → New → Import, sube el `dashboards/mikroscope-<almacén>.json` que corresponda
a tu fuente de datos (influxdb, prometheus, postgres, graphite o elasticsearch) y elige la fuente de
datos cuando Grafana pida `DS_MIKROSCOPE`.
