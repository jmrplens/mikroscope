...
Esta página responde a cómo meter los dos dashboards en un Grafana, qué necesita la fuente de datos
...
- [Dos paneles, una sola lista](/mikroscope/es/dashboards/): cada sección y cada panel, y qué almacén
  lleva cada uno.
