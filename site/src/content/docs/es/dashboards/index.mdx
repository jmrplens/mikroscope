---
title: Dos paneles, una sola lista
description: Qué contienen los dashboards de InfluxDB 3 y de Prometheus, sección a sección y en el orden en que se leen, y por qué los dos almacenes no llevan los mismos paneles.
---
...
Los dos dashboards están en el formato de exportación compartible de Grafana: la fuente de datos es
