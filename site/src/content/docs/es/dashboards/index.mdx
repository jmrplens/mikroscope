...
mismo índice había mapeado el campo como si no. Así que en Elasticsearch un cero plano en esta fila
significa que el router no produce la medida, que es lo que dice el título de la fila. Las
