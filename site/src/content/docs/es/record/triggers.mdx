...
description: Cómo guarda el agente muestras a cadencia completa en torno a tu condición, qué dispara, cómo traer una captura y por qué es una muestra, no un censo.
---
