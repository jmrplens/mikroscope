...
description: Cómo traer a tu máquina una ventana de muestras a cadencia completa, marcar sus momentos, añadir el log del router y dibujarla como un SVG determinista.
head:
  - tag: title
    content: Grabar, marcar y dibujar un router MikroTik | mikroscope
---
