...
<Aside type="caution" title="Una petición por relay llena aún puede llegar al límite">
	...
	Con <Measured id="relay.maxBatch" /> muestras por petición y el `--poll` por defecto de 500 ms, el relay
	lleva 26 muestras por segundo; por encima de eso, usa la vía directa.
</Aside>
