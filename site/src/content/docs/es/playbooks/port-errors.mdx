...
description: "Un puerto MikroTik que cuenta rx-overflow: distinguir carga de microrráfaga con los contadores del puerto, qué no lo arregló y el ritmo del emisor que sí."
head:
  - tag: title
    content: "rx-overflow en un puerto MikroTik: ¿carga o ráfaga? | mikroscope"
---
...
intervalos que desbordaban al <Measured id="overflow.occupancy" /> del enlace. Ni
...
de <Measured id="overflow.perHourBefore" /> desbordes por hora a ninguno en los 39
minutos medidos.
