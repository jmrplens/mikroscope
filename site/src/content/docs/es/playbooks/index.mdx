...
| [Puertos de RouterOS y nombres del kernel](/mikroscope/es/playbooks/port-names/) | un puerto muerto apagado y vuelto a encender               | `events`                                              | el kernel escribe `eth5` donde RouterOS dice `ether6`                                                                         |
