...
```text
/ip/firewall/connection/print count-only     # 6 212, más o menos un día antes de las lecturas del slab (la fecha no consta)
```

Las lecturas del slab del 2026-09-12 fueron 6 582 y <Measured id="conntrack.slab" />, y el fragmento
de arriba recogió un tercer momento, 6 240. Con un día de diferencia, muestran el mismo orden de
