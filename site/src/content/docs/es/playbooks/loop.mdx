...
`sfp-sfpplus1`, volviendo a entrar en el bridge.
...
kernel](/mikroscope/es/playbooks/port-names/) explica cómo hacerlo en un solo paso
...
- [Puertos de RouterOS y nombres del kernel](/mikroscope/es/playbooks/port-names/): cómo `eth1` resultó
