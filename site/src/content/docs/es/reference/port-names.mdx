...
description: El log del kernel dice eth5 donde RouterOS dice ether6 — cómo medir la correspondencia en un puerto muerto en un solo paso seguro, qué incluye el agente para el RB5009 y cuánto de esa tabla se midió.
---
...
anillo entero del agente en marcha, 60 s por defecto (el `BUFFER_S` del agente).
