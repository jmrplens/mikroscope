...
sin el prefijo `MIKROSCOPE_`. La ayuda general aún describe `dashboards` como "Grafana dashboards
for InfluxDB 3 and Prometheus"; el código acepta los cinco almacenes de la tabla de arriba.
