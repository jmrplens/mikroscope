...
| 25 MiB (el factor 2,5× a 300 s) | 2,5×                | ~26 MiB   | ~2 780 µs       | sin coste medible         |
| 21 MiB        | 2,1×                | 23,5 MiB  | 3 250 µs        | +22 %, y subiendo         |
| 18 MiB        | 1,8×                | 20,4 MiB  | 14 800 µs       | +457 %, peor tick 52 ms   |

La fila de 25 MiB es aproximada. El comentario de `memLimitRingFactor` en
`internal/router/options.go` registra esa ventana como 24 MiB (2,4×), con 26,3 MiB de RSS y
2 780 µs por muestra, y ninguna de las cuatro ventanas se anotó con su dispersión.
