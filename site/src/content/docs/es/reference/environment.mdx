...
Las filas son las que registra el comentario de `memLimitRingFactor` en
`internal/router/options.go`. El factor 2,5× que deriva `install` daría 25 MiB a 300 s; la ventana
