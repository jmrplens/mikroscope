...
<Aside type="caution" title="La alerta generada para InfluxDB pide el nombre de columna de SQL">
...
| Dato                              | InfluxDB                                                                                                                                   | SQL                                                                                   |
| --------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------- |
| frecuencia de CPU                 | `mikroscope_cpufreq`                                                                                                                       | `mikroscope_cpufreq`                                                                         |
| interrupciones y softirqs por CPU | `mikroscope_irq_cpu`, `mikroscope_softirq`                                                                                                 | `mikroscope_irq_cpu`, `mikroscope_softirq`                                   |
| eventos y niveles de vmstat       | `mikroscope_vm`, `mikroscope_vm_level`                                                                                                     | `mikroscope_vm`, `mikroscope_vm_level`                                   |
| contadores del PMU                | `mikroscope_perf`                                                                                                                          | `mikroscope_perf`                                                                        |
| secuencia y relojes de la muestra | `mikroscope_sample`                                                                                                                        | `mikroscope_sample`                               |
| `/proc/meminfo`                   | diecinueve campos en `mikroscope_mem`                                                                                                      | diecinueve columnas en `mikroscope_mem`                                                    |
...
| extras del observador             | `cgroup_mem_max`, `resets`, `kmsg_dropped` en `mikroscope_self`                                                                            | todos salvo `cgroup_mem_max`                                                                        |
