...
description: "Tres capas de pruebas: los bytes de cada destino, si un almacén real los acepta, si responden los paneles; qué prueba cada una y qué no prueba ninguna."
---
...
binario real del agente contra <Src path="testdata/proc/rb5009/" />, un árbol `/proc` y
