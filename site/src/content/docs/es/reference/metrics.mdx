...
<NotClaimed variant="untested">
	Las dos últimas siguen siendo aritmética, de `internal/expo/expo.go`: el `Totals` del colector se
...
daban todo ceros (`internal/dashboards/panels.go`, el panel de E/S en curso de
