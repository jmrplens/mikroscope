...
nombra la opción con la que volver a ejecutar. Para `arm` el agente se compila
con `--goarm`, por defecto `7`, y la imagen declara la variante v7.
...
lee ese ajuste y nunca lo escribe;
