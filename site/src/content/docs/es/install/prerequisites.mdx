...
`--remote-image jmrplens/mikroscope-agent:1.2.0`, no necesita fijar nada ahí en
...
- **`layer2-loop`**: tres o más tramas en la ventana que volvieron a entrar por
  ...
  cada <Measured id="loop.helloGap" />, el intervalo de hello de STP —treinta veces en un anillo de 60 s—, mientras
