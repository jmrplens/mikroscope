...
description: Dónde vive en el router cada objeto que crea `install`, qué disco guarda la imagen y la raíz, qué lleva la envlist y los ajustes del contenedor que escribe install.
---
