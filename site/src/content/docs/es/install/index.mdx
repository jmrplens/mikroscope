...
solo quita con `--yes`; `scripts/roundtrip.sh` aún no lo pasa, así que el guion
tal como se publica solo enumera en su paso de desinstalación y su comprobación
del export falla después. Cada objeto que crea install lleva el comentario
