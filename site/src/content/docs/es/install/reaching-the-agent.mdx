...
description: El agente solo escucha en su veth — cómo llega a él tu máquina, directa, por el relay de la API de RouterOS o con `--expose`, y qué cuesta cada vía.
---
...
`internal/version.Version`, y tanto el <Src path="Makefile" /> como la release lo toman del
fichero <Src path="VERSION" />, así que un agente puesto ahí por 1.0.0 informa `1.0.0`. Un
...
## `--expose`, en la dirección LAN del router {#expose-en-la-dirección-lan-del-router}
