...
description: The JSONL file, standard output, SQL and PostgreSQL, Loki, OTLP, Graphite, Elasticsearch and Telegraf — what each one carries, how it delivers, and what its protocol cannot promise.
---
