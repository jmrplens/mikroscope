...
description: "The JSONL file, stdout, SQL, PostgreSQL, Loki, OTLP, Graphite, Elasticsearch and Telegraf: what each sink carries, how it delivers, what it cannot promise."
---
...
3](/mikroscope/sinks/influxdb/), `forward` writes to nine more destinations. This page
...
<ScrollTable label="What each of the nine sinks receives">
...
`agent-size` job still holds it under the <Measured id="budget.image" /> budget.
...
<Aside type="caution" title="A password in a DSN is visible in the process list">
