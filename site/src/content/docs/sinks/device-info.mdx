...
description: What the agent learns about a MikroTik board without the RouterOS API (identity, ceilings, cadences) and how every sink receives it as facts, not samples.
---
...
the code (`capsHash` in <Src path="internal/agent/source.go" />), not observed.
