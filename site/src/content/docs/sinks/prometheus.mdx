---
title: Prometheus
description: "MikroTik RouterOS kernel metrics on the collector's /metrics: every agent family recomputed from the samples, the API tier, derived values, one scrape job."
head:
  - tag: title
    content: MikroTik RouterOS kernel metrics in Prometheus | mikroscope
---
...
<ScrollTable label="Where the collector's families come from">
