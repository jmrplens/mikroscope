---
title: Detections
description: "The eleven detection rules mikroscope runs on MikroTik RouterOS kernel data: the exact condition of each, what it needs, and what it may not claim."
head:
  - tag: title
    content: Fault detection rules for MikroTik RouterOS | mikroscope
---
