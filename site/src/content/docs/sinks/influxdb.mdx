---
title: InfluxDB 3
description: "MikroTik RouterOS kernel telemetry into InfluxDB 3 over /api/v3/write_lp: URL and token, delivery and drops, every measurement, and what Core refuses."
head:
  - tag: title
    content: MikroTik RouterOS kernel telemetry in InfluxDB 3 | mikroscope
---
