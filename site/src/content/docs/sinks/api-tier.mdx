...
cadence: <Measured id="api.conntrackMs" /> at <Measured id="conntrack.api" /> entries on the RB5009 (about 2026-09-11, a day before the slab reading; not recorded more precisely), a single reading with no spread. It is off by default because it
