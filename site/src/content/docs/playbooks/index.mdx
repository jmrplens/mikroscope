...
description: Eight readings of kernel and port data from one RB5009 — two production faults found without looking for them, three events provoked on purpose, two that needed no provoking, and the idle shape they are read against.
---
