...
description: "The real conntrack count of a MikroTik router from inside a RouterOS container: the nf_conntrack slab where the namespace says 0, checked against the API."
head:
  - tag: title
    content: "RouterOS conntrack count from a container | mikroscope"
---
