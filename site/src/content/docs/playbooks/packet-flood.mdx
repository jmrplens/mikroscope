...
description: "A 10 s ICMP flood at a MikroTik RB5009, read from inside its container: the switch interrupt standing in for a port counter, one core paying, time_squeeze."
head:
  - tag: title
    content: "A packet flood seen from a RouterOS container | mikroscope"
---
