...
description: How the agent keeps full-rate samples around a condition you set, what fires, how to fetch a capture, and why it samples events rather than counts them.
---
