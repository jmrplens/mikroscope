...
about 7.3 MB and a 14 MiB limit kept the garbage collector running continuously on the RB5009: <Measured id="gc.tight.cpu" /> of one core against <Measured id="gc.roomy.cpu" /> with room, both with the ring full, measured
