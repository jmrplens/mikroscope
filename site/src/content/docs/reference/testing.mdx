...
description: "Three test layers: the bytes each sink sends, whether a real store takes them, whether the dashboards' queries answer; what each proves and what none does."
---
...
binary against <Src path="testdata/proc/rb5009/" />, a captured `/proc` and `/sys` tree of
