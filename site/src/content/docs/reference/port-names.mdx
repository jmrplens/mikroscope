...
description: "The kernel log says eth5 where RouterOS says ether6: measuring the mapping on a dead port in one safe step, and how much of the RB5009 table was measured."
---
