...
description: Every family on the agent’s /metrics and on the collector’s --prom exposition, grouped by source, with its type, its labels and when it is absent.
---
...
<ScrollTable label="Which exposition carries what">
