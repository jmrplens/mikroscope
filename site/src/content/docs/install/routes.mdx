...
| [A registry pull](#a-registry-pull)              | the router reaches the registry; Docker Hub needs no `registry-url` change | you are installing a release and nothing should land on the flash |
