...
measurement is not an error there ([why](/mikroscope/dashboards/#not-available-on-this-device)).
...
probed `import` from 1.3.0 and from 1.3.1, and the detections layer.
