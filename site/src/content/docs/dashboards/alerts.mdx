---
title: Alert rules
description: "The Grafana alert rules generated beside the dashboards: what each fires on, where its threshold comes from, and what has not been tested about them."
---
...
| ---------------------------------------------- | -----------------------------------------------: | -------------- |
| <Src path="dashboards/mikroscope-alerts-influxdb.yaml" />   |   <DashboardCount store="influxdb" of="rules" /> | InfluxDB 3 SQL |
| <Src path="dashboards/mikroscope-alerts-prometheus.yaml" /> | <DashboardCount store="prometheus" of="rules" /> | PromQL         |
| <Src path="dashboards/mikroscope-alerts-postgres.yaml" />   |   <DashboardCount store="postgres" of="rules" /> | PostgreSQL SQL |
...
(<Src path="internal/dashboards/panels.go" />), and worse: a panel at least fails loudly with a 500.
