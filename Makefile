...
#
# The floor sits just under what was measured when it was set: 89.1% over
...
# raise it when the total rises. What is left, and the techniques that reached
# the rest, are in CONTRIBUTING.md.
COVERAGE_MIN      := 88
