...
func lokiKernel(seq uint64) Event {
	...
	e.Kernel.Events = []procfs.KmsgRecord{
		...
		{Priority: 3, Level: 3, Facility: 0, Seq: 4414, TimeUsec: 91_240_000, Message: "br0: received packet on eth1 with own address as source address (addr:78:9a:18:b7:06:5d)"},
	}
	return e
}
...
func TestLokiSinkPushesEventsGapsAndAPIErrors(t *testing.T) {
	...
	for _, want := range []string{
		...
		`{"stream":{"host":"rb5009","level":"err","source":"kmsg"},"values":[["1788000000100000002","br0: received packet on eth1 with own address as source address (addr:78:9a:18:b7:06:5d) level=err facility=0 prio=3 kseq=4414 us=91240000 seq=1"]]}`,
