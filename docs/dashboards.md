...
`dashboards/` holds one Grafana dashboard per store — five of them — all generated by
...
expanded, and which panels some stores cannot carry. Importing them and checking them
