...
Every measurement the InfluxDB line-protocol encoder writes and every table the SQL sink creates, with tags, fields, columns, keys, units and whether each value is a delta or a level.
...
do not hold the same set; [where they differ](https://jmrp.io/docs/mikroscope/reference/measurements/#where-the-two-stores-differ)
is the last section.
